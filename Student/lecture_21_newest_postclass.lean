...
Let's start by building on our understanding of predicates. -- remember predicate is one that requires arguments to have a value. Proposition just has a value, true or false.
