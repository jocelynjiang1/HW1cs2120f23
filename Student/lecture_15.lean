...
our main new topic: *satisfiability modulo theories*. -- solver for an SMT problem allows propositions to be written in various background expressions
-/
-- a SAT solver is in lecture_14.py
