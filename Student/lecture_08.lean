...
public class HelloWorld {
    public static void main(String[] args) { // void in java is the equivalent of (actually, is a) Unit type
...
doesn't really return nothing, it returns a value but
